	...
	<div class="main-block">
		...
		<form action="sok" method="post">
			<div class="title">
				...
				<h2>Syner reservasjon</h2>
			</div>

			<div>
				<label> Reservasjonsnr. : ${reservasjon.reservasjonsid} <br></label>
				<label> Fra dato        : ${reservasjon.fradato} <br></label> 
				<label> Til dato        : ${reservasjon.tildato} <br></label> 
				<label> Registreringsnr.: ${reservasjon.getBilBean().regnr} <br></label>
